...
// bootstrap-ts text in includes/boxes/bootstrap-ts.php
define('BOX_HEADING_BTS', 'Bootstrap-TS');
define('BOX_CSS_EDITOR', 'B-ts Css-editor');
define('BOX_HEADING_BTS_HEADER_BUILDER', 'B-ts Builder');
