            ...
            if ( isset($this->_data[$parent_id]) ) {
                foreach ( $this->_data[$parent_id] as $category_id => $category ) {
                    ...
                    if($category['selectors_type'] == 'media'){          
                        ...
                        $result .=  htmlspecialchars_decode($category['selectors_name']) . '{' . PHP_EOL;
                    ...
                    if($category['selectors_type'] == 'default'){          
                        ...
                        $result .=  htmlspecialchars_decode($category['selectors_name']) . '{' . PHP_EOL;
                        $result .=	htmlspecialchars_decode($category['selectors_properties']) . PHP_EOL;
                        $result .= '}' . PHP_EOL;
