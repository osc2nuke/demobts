...
define('IMAGE_BUTTON_IN_CART', 'Add to Workstation');
...
define('TEXT_GREETING_PERSONAL', '<div class="alert alert-info text-center">Welcome back <span class="greetUser">%s! </span> Choose a template from the box on the left</div>');
define('TEXT_GREETING_PERSONAL_RELOGON', '<small>If you are not %s, please <a href="%s"><u>log yourself in</u></a> with your account information.</small>');
define('TEXT_GREETING_GUEST', '<div class="alert alert-info text-center">Welcome <span class="greetUser">Guest!</span> To see the demo you must <a type="button" class="btn btn-default" href="%s">log yourself in</a> - Or - <a type="button" class="btn btn-default" href="%s">create an account</a></div>');
